...
public class LinkedListDeque61BTest {
    ...
    public void GetTest() {
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
        assertThat(lld1.get(-1)).isEqualTo(null);//neg
        lld1.addLast(0);
        assertThat(lld1.get(0)).isEqualTo(0);//valid
        assertThat(lld1.get(1)).isEqualTo(null);//out of bound
        lld1.addLast(1);
        lld1.addLast(2);
    ...
    @Test
    public void getRecursiveText(){
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
        assertThat(lld1.getRecursive(-1)).isEqualTo(null);//neg
        lld1.addLast(0);
        assertThat(lld1.getRecursive(0)).isEqualTo(0);//valid
        assertThat(lld1.getRecursive(1)).isEqualTo(null);//out of bound
        lld1.addLast(1);
        lld1.addLast(2);
...
Check that removing the second to last element with removeLast works.*/
    public void removeFirstAndRemoveLastText() {
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
        lld1.addLast(0);   // [0]
        lld1.addLast(1);   // [0, 1]
        lld1.addFirst(-1); // [-1, 0, 1]
        ...
        lld.addLast(1);
        lld.removeLast();
        assertThat(lld.toList()).containsExactly( 0);
        lld.removeLast();
